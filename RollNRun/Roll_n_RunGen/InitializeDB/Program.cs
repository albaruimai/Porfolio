...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: Roll_n_RunGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("Roll_n_RunGenNHibernate", "nhibernateUser", "nhibernatePass");
